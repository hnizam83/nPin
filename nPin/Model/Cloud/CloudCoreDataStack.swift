...
//  nPin
//
//  Created by Hamza Nizameddin on 04/08/2021.
//
...
class CloudCoreDataStack
{
	...
	lazy var container : NSPersistentCloudKitContainer =
		{
			let container = NSPersistentCloudKitContainer(name: "nPinCloud")
	 ...
	 */
	public func getCards(with searchString: String? = nil, filter: String? = nil, sortKey: String? = nil, sortOrderAscending: Bool? = nil) -> [CloudCard]
	{
		let context = self.container.viewContext
		var cards = [CloudCard]()
	 ...
	 */
	public func deleteCard(_ cloudCard: CloudCard)
	{
		self.container.viewContext.delete(cloudCard)
		self.saveContext()
	}
	 ...
	 */
	@discardableResult
	public func createCard(digits: String, pin: String, name: String?, order: Int16, lastAccessed: Date = Date(), favorite: Bool = false, colorAsHex: String) -> CloudCard?
	{
		...
		let card = CloudCard(context: self.container.viewContext)
	 ...
	 */
	@discardableResult
	public func updateCard(card: CloudCard, digits: String? = nil, pin: String? = nil, name: String? = nil, order: Int16? = nil, lastAccessed: Date? = nil, favorite: Bool? = nil, colorAsHex: String? = nil) -> Bool
	{

...
/**
 LocalCard entity for storage in iCloud Core Data.
...
extension LocalCard
{
	 ...
	 */
	@nonobjc public class func fetchRequest(with searchString: String?) -> NSFetchRequest<LocalCard>
	{
	 ...
	 */
	public func initializeFakePins(count: Int = 9)
	{
